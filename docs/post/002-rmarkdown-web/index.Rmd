...
knitr::include_graphics("portada_web_rmarkdown.png", error = F)
```
...
knitr::include_graphics(c("newRproject.png", 
                          "newRproject_directory.png", 
                          "newRproject_type.png", 
                          "newRproject_name.png"), error = F)
```
...
knitr::include_graphics("rstudio_screen.png", error = F)
```
...
knitr::include_graphics(c("github_new_repo.png", 
...
knitr::include_graphics(c("github_upload_files1.png", 
                          "github_upload_files2.png"))
```
...
knitr::include_graphics(c("github_pages1.png", 
                          "github_pages2.png"))
```
